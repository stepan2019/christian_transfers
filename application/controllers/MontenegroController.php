 ...
 */
	...
	class MontenegroController extends Zend_Controller_Action
	{
		public $view;
		...
		$title=$titluri["montenegroTitle"];
		$meta=$titluri["montenegroMeta"];
...
$this->view->assign("description",$meta);
	...
	echo $this->view->render('montenegro.phtml');
	//print_r ($_SESSION);
    }
}
?>