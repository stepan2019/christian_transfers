 ...
 */
	...
	class SuppliersController extends Zend_Controller_Action
	{
		public $view;
		public function init()
		{
			$this->view = Zend_Registry::get('VIEW');
			$this->view->setScriptPath('application/views/scripts/suppliers');
		}
		...
		$title=$titluri["suppliersTitle"];
		$meta=$titluri["suppliersMeta"];
...
$this->view->assign("description",$meta);
	...
	echo $this->view->render('suppliers.phtml');
	//print_r ($_SESSION);
    }
}
?>