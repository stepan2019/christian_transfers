...
class Page2busesController extends Zend_Controller_Action
{
    public $view;
    ...
    public function init()
    {
        ...
        $this->view->setScriptPath('application/views/scripts/page2buses');
    }
...
//            $percentAddedDepCountry = $q->f($monthToWord[$monthDep])/100;
                    ...
                    if ($days_dep != '') {
                        ...
                        if ($_SESSION["ret-date"]) {
                            ...
                            if (in_array($selected_date_dep, $days_array_dep) || in_array($selected_date, $days_array)) {
                                ...
                                $(document).ready(function () { 
                                    $.ajax({
                                       url: "/application/search_buses.php",
                                       type: "get",
                                       dataType: "html",
        ...
        if ($id_tara == 34) {
            echo $this->view->render('page2buses_uk.phtml');
        } else {
            echo $this->view->render('page2buses.phtml');
        }//print_r ($_SESSION);
    }
}
