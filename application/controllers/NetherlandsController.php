 ...
 */
	...
	class NetherlandsController extends Zend_Controller_Action
	{
		public $view;
		...
		$title=$titluri["netherlandsTitle"];
		$meta=$titluri["netherlandsMeta"];
...
$this->view->assign("description",$meta);
	...
	echo $this->view->render('netherlands.phtml');
	//print_r ($_SESSION);
    }
}
?>