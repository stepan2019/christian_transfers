 ...
 */
	...
	class LimousinesController extends Zend_Controller_Action
	{
		public $view;
		...
		$title=$titluri["limousinesTitle"];
		$meta=$titluri["limousinesMeta"];
...
$this->view->assign("description",$meta);
	...
	echo $this->view->render('limousines.phtml');
	//print_r ($_SESSION);
    }
}
?>