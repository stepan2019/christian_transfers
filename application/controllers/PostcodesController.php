 ...
 */
	...
	class PostcodesController extends Zend_Controller_Action
	{
		public $view;
		public function init()
		{
			$this->view = Zend_Registry::get('VIEW');
			$this->view->setScriptPath('application/views/scripts/postcodes');
		}
		...
		$title=$titluri["postcodesTitle"];
		$meta=$titluri["postcodesMeta"];
...
$this->view->assign("description",$meta);
	...
	echo $this->view->render('postcodes.phtml');
	//print_r ($_SESSION);
    }
}
?>