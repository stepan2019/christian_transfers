 ...
 */
	...
	class SwitzerlandController extends Zend_Controller_Action
	{
		public $view;
		...
		$title=$titluri["switzerlandTitle"];
		$meta=$titluri["switzerlandMeta"];
...
$this->view->assign("description",$meta);
	...
	echo $this->view->render('switzerland.phtml');
	//print_r ($_SESSION);
    }
}
?>