...
<div class="wrap  search-section">
    <div role="tabpanel">
        ...
        <!-- BEGIN: TAB PANELS -->
        <div class="tab-content" style="text-align:left;margin-top:35px;">
            <!-- BEGIN: FLIGHT SEARCH -->
            <div role="tabpanel" class="tab-pane active container-fluid" id="transfers">
                <form id="search_transfer" role="form" method='post'
                      action='/airport_transfer/<?php print $nume_tara . "-" . $url_aeroport . "-" . $url_destinatie; ?>'>
                    <!-- Row -->
                    <h3 style="text-decoration: underline;">BOOK AIRPORT TRANSFERS</h3>
                    <div class="f-row">
...
//			).on('dp.change', function (e) { console.log('aa'); $('#search_transfer').find(':submit').click();  });
            ...
            <div role="tabpanel" class="tab-pane" id="trains">
                <form id="search_transfer" role="form" method='post'
                      action='/airport_transfer/<?php print $nume_tara . "-" . $url_aeroport . "-" . $url_destinatie; ?>'>
                    <!-- Row -->
                    <h3 style="text-decoration: underline;">BOOK TRAINS TICKETS</h3>
                    <div class="f-row">
                        <div class="form-group datepicker one-fourth">
                            <label for="dep-date">Departure date</label>
                            <input type="text" id="dep-date" name="dep-date"
...
//			).on('dp.change', function (e) { console.log('aa'); $('#search_transfer').find(':submit').click();  });
            ...
            <div role="tabpanel" class="tab-pane" id="buses">
                <form id="search_transfer" role="form" method='post'
                      action='/airport_transfer/<?php print $nume_tara . "-" . $url_aeroport . "-" . $url_destinatie; ?>'>
                    <!-- Row -->
                    <h3 style="text-decoration: underline;">BOOK BUS TRANSFERS</h3>
                    <div class="f-row">
                        <div class="form-group datepicker one-fourth">
                            <label for="dep-date">Departure date</label>
                            <input type="text" id="dep-date" name="dep-date"
