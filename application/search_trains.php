...
<div class="wrap">
    <form id="search_transfer" role="form" method='post'
          action='/airport_trains/<?php print $nume_tara . "-" . $url_aeroport . "-" . $url_destinatie; ?>'>
        <!-- Row -->
        <div class="f-row">
            <div class="form-group datepicker one-fourth">
                ...
                <input type="text" id="dep-date" name="dep-date"
                       value="<?php echo (isset($_SESSION['dep-date'])) ? $_SESSION['dep-date'] : ''; ?>" required/>
            </div>

            <div class="form-group select one-fourth">
                <label>Pick up location</label>
                <select class="select-wo" id="pickup_locatie" name="pickup_locatie" required onchange="searchdb();">
                    <option value=""></option>
                    <?php
            ...
            <div class="form-group select one-fourth">
                ...
                <select class="<?php echo (isset($_POST["pickup_locatie"]) || isset($_SESSION["pickup_locatie"])) ? 'select-wo' : ''; ?>"
                        id='id_destinatie' name='id_destinatie' class='search_select1' required onchange="searchdb();">
                    <option value=''></option>
                    <?php
                    // start ID_DESTINATIE ----------------------------------------------------------------------------------------------------------------------------
            ...
            <div class="form-group select one-fourth">
                ...
                <input placeholder="including children" type="number" name="arrival_passengers" id="arrival_passengers"
                       value="<?php echo $_SESSION['arrival_passengers']; ?>" min="1" required onchange="searchdb();"/>
            </div>
        </div>
        ...
        <div class="f-row" <?php echo (isset($_SESSION["oneway"]) && $_SESSION["oneway"] == 1) ? 'style="display:none;"' : ""; ?>>
            ...
            <div class="form-group select one-fourth">
                ...
                ?>
                <select class="<?php echo (!empty($orase_return)) ? 'select-wo' : ''; ?>" id="pickup_locatie_return"
            ...
            <div class="form-group select one-fourth">
                ...
                <select class="<?php echo (!empty($show_select_wo_class)) ? 'select-wo' : ''; ?>"
                        id='id_destinatie_return' name='id_destinatie_return' required onchange="searchdb();">
                    <option value=""></option>
                    <?php
            ...
            <div class="form-group select one-fourth">
                <label for="people">How many people?</label>
                <input placeholder="including children" type="number" name="dep_passengers" id="dep_passengers"
                       value="<?php echo $_SESSION['dep_passengers']; ?>" min="1" required onchange="searchdb();"/>
            </div>
        </div>
        ...
        <div class="f-row">
            <div class="form-group radios">
                <div>
                    <div class="radio" id="uniform-return"><span><input type="radio" name="oneway" id="return"
                                                                        value="0" <?php echo $selected0; ?>/></span>
                    </div>
                    <label for="return">Return</label>
                </div>
                <div style="padding-left:30px;">
                    <div class="radio" id="uniform-oneway"><span><input type="radio" name="oneway" id="oneway"
            ...
            <div class="form-group right">
                <button type="button" name="sendbtn" onclick="javascript:void(0);" id="sendbtn" class="btn large black">
                    Find a trains
                </button>
