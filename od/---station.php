<?php
    ...
    $description = $station->name . " " . $stationCode . " - " . stopTypePrint($station->stopType) . " - London" ;
            ...
            echo "<div class=\"card-body\">\r\n ";
                ...
                if (!empty($decoded)) {
                    //echo "<pre>"; print_R($decoded); echo "</pre>";
                        ...
                        echo "<thead><tr><th>time to<br>Arrival</th><th>type</th><th>Line / Start - End</th><th>Stop point</th></tr></thead>\r\n";
                        $k=1;
                        foreach ($formated as $time => $value) {
                            ...
                            foreach ($rows as $item) {
                                if ($k < 15) {
                                    ...
                                    echo "<tr><td><b>$time" . " min</b></td><td><a href=\"/od/lines/$item[mode]/\">$item[mode]</a></td><td><b>#$item[line]</b> <small><a href=\"/od/station/$item[originator]/$slug1\">$item[lineFrom]</a> - <a href=\"/od/station/$item[destination]/$slug2\">$item[lineTo]</a></small></td><td><a href=\"/od/stop-point/$item[code]/$slugStopPoint\" style=\"color:#000;\">$item[station]</a> <small>(#$item[code])</small></td></tr>\r\n";
                                }
                                $k++;
                            }
