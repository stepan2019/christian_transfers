<?php
  ...
  $row = $db->get_row("SELECT * FROM tfl_stations WHERE code = '$id' limit 1");
...
$gmapsKey = 'AIzaSyDhzq0vdhpQKEy4OoB81xqyGcVJw-3_LaA';
  ...
  echo "<div class=\"popup_map\">\r\n";
	...
	echo "<a href=\"" . $href . "\" rel=\"nofollow\" target=\"_blank\">
					<img src=\"$src\" width=\"470\" height=\"300\" alt=\"Google map\" />
	</a>";
