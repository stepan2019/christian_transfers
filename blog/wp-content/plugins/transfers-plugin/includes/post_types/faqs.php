...
class Transfers_Faqs_Post_Type extends Transfers_BaseSingleton {
	...
	function register_faq_category_taxonomy() {
		...
		$labels = array(
				'name'              			=> esc_html__( 'Categories', 'taxonomy general name', 'transfers' ),
				'singular_name'     			=> esc_html__( 'Category', 'taxonomy singular name', 'transfers' ),
	...
	function register_faq_post_type() {
		...
		$labels = array(
			'name'                => _x( 'Faqs', 'Post Type General Name', 'transfers' ),
			'singular_name'       => _x( 'Faq', 'Post Type Singular Name', 'transfers' ),
