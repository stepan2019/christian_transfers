...
class Transfers_Extra_Items_Post_Type extends Transfers_BaseSingleton {
	...
	protected function __construct() {
		...
		// if ($this->enable_extra_items) {
			...
			// $this->extra_item_custom_meta_fields = array(
				...
				// ),
				// array( // Post ID select box
					// 'label'	=> esc_html__('Max allowed items per shared transfer per person?', 'transfers'), // <label>
					// 'desc'	=> esc_html__('How many pieces of the extra item are allowed per shared transfer per person?', 'transfers'), // description
				...
				// array( // Post ID select box
					...
					// 'desc'	=> esc_html__('How many pieces of the extra item are allowed per private transfer?', 'transfers'), // description
	...
	function register_extra_item_post_type() {
		...
		$labels = array(
			'name'                => _x( 'Extra items', 'Post Type General Name', 'transfers' ),
			'singular_name'       => _x( 'Extra item', 'Post Type Singular Name', 'transfers' ),
