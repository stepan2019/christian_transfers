	...
	*/
	...
	function column_Price( $item ) {
		...
		if ($transfers_plugin_globals->show_currency_symbol_after())
			return ($item->price_private . $currency_symbol) . ' / ' . ($item->price_share . $currency_symbol);
		else
			return ($currency_symbol . $item->price_private) . ' / ' . ($currency_symbol . $item->price_share);
	}
	...
	function get_columns() {
		return $columns= array(
			...
			'Price'=>__('Prices (private/share)', 'transfers'),
