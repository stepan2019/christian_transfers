					...
					init: function () {
						...
						if ($.fn.datepicker) {
							if (typeof($("#datepicker_booking_datetime")) != 'undefined') {
								$("#datepicker_booking_datetime").datepicker({
								...
								if (typeof(window.datepickerBookingDateValue) != 'undefined' && window.datepickerBookingDateValue.length > 0) {
									$('#datepicker_booking_datetime').datepicker("setDate", window.datepickerBookingDateValue);
								}
							}
...
class Bookings_Admin_List_Table extends WP_List_Table {
	...
	*/
	...
	function render_entry_form($entry_id) {
		...
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('First name', 'transfers') . '</th>';
		echo '	<td><input type="text" name="first_name" id="first_name" value="' . $first_name . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Last name', 'transfers') . '</th>';
		echo '	<td><input type="text" name="last_name" id="last_name" value="' . $last_name . '" /></td>';
		echo '</tr>';

		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Email', 'transfers') . '</th>';
		echo '	<td><input type="text" name="email" id="email" value="' . $email . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Phone', 'transfers') . '</th>';
		echo '	<td><input type="text" name="phone" id="phone" value="' . $phone . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Address', 'transfers') . '</th>';
		echo '	<td><input type="text" name="address" id="address" value="' . $address . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Town', 'transfers') . '</th>';
		echo '	<td><input type="text" name="town" id="town" value="' . $town . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Zip', 'transfers') . '</th>';
		echo '	<td><input type="text" name="zip" id="zip" value="' . $zip . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('State', 'transfers') . '</th>';
		echo '	<td><input type="text" name="state" id="state" value="' . $state . '" /></td>';
		echo '</tr>';
		
		echo '<tr>';
		echo '	<th scope="row" valign="top">' . esc_html__('Country', 'transfers') . '</th>';
		...
		if (isset($booking_datetime)) {
			echo '		<script>';
			echo '			window.datepickerBookingDateValue = "' . date( $this->date_format, strtotime( $booking_datetime ) ) . '";';
			echo '  	</script>';	
		}		
