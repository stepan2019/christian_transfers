...
function transfers_advanced_search_enqueue() {
	...
	wp_register_script(	'transfers-timepicker', TRANSFERS_PLUGIN_URI . '/js/jquery-ui-timepicker-addon.min.js', array('jquery', 'jquery-ui-datepicker'), '1.0',true);
	...
	if (transfers_does_file_exist(TRANSFERS_PLUGIN_URI . '/js/i18n/jquery-ui-timepicker-' . $language_code . '.js')) {
					...
					<div class="f-row">
						<div class="form-group datepicker one-third">
							...
							<?php if (isset($departure_date)) { ?>
								<script>
								window.datepickerDepartureDateValue = '<?php echo esc_js(date($date_format, strtotime($departure_date))); ?>';
								</script>
							<?php } ?>
						</div>
					...
					<div class="f-row" <?php echo wp_kses(($trip != 2 ? ' style="display: none;"' : '') , array('style' => array())); ?>>
						<div class="form-group datepicker one-third">
							...
							<?php if (isset($return_date)) { ?>
								<script>
								window.datepickerReturnDateValue = '<?php echo esc_js(date($date_format, strtotime($return_date))); ?>';
								</script>
							<?php } ?>
						</div>
						<div class="form-group select one-third">
