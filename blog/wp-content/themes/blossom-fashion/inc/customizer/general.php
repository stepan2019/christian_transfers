    ...
    if( blossom_fashion_is_btif_activated() ){
        ...
        $wp_customize->add_control(
            new Blossom_Fashion_Note_Control( 
    			...
    			array(
    				'section'	  => 'instagram_settings',
    				'description' => sprintf( __( 'You can change the setting of BlossomThemes Feed for Instagram %1$sfrom here%2$s.', 'blossom-fashion' ), '<a href="' . esc_url( admin_url( 'admin.php?page=class-blossomthemes-instagram-feed-admin.php' ) ) . '" target="_blank">', '</a>' )
    			)
    		)
        );        
    }else{
