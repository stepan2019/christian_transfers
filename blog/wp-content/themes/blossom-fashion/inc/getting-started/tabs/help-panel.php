...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.blossomthemes.com/' . BLOSSOM_FASHION_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-fashion' ); ?>" target="_blank"><?php esc_html_e( 'View Demo', 'blossom-fashion' ); ?></a>
    </div><!-- .panel-aside -->
</div>
