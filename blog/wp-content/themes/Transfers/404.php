	...
	<div class="wrap">
		<div class="row">
			...
			<div class="content one-half right textongreyRight">
				...
				<p><?php echo sprintf(esc_html__('If you believe that this is an error, please kindly <a href="%s">contact us</a>. Thank you!', 'transfers'), esc_url($transfers_theme_globals->get_contact_page_url())) ?></p>
				<p><?php echo sprintf(esc_html__('You can go <a href="%s">back home</a> or try using the search.', 'transfers'), esc_url( home_url('/')) ) ?></p>
			</div>
			<!--- //Content -->
		</div>
	</div>
