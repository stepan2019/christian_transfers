...
require_once get_stylesheet_directory() . '/includes/plugins/urlify/URLify.php';
require_once get_stylesheet_directory() . '/includes/themeenergy_common.php';
require_once get_stylesheet_directory() . '/includes/theme_utils.php';
...
function transfers_register_required_plugins() {
    ...
    $plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/includes/plugins/transfers-plugin/transfers-plugin.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '1.02', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
