		...
		?>
			<article class="transfers_contact_widget one-fourth">
				...
				<p class="contact-data">
					<span class="ico themeenergy_telephone_2"></span> <?php echo esc_html($company_phone); ?>
				</p>	
				<?php 
				} 
				if (!empty($company_email)) { ?>
				<p class="contact-data">
					<span class="ico themeenergy_mail"></span> <a href="mailto:<?php echo esc_attr($company_email); ?>"><?php echo esc_html($company_email); ?></a>
				</p>
				<?php } ?>
			</article>
		<?php
