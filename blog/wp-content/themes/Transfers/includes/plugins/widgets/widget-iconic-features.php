...
<?php
					...
					foreach ($widget_features as $widget_feature) {
						...
						?>
						<!-- Item -->
						<div class="<?php echo esc_attr($feature_class); ?> wow fadeIn" data-wow-delay=".<?php echo esc_attr($delay); ?>s">
							<span class="circle"><span class="ico <?php echo esc_attr($widget_feature['class']); ?>"></span></span>
