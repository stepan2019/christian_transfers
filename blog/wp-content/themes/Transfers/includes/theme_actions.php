...
class Transfers_Theme_Actions extends Transfers_BaseSingleton {
	...
	function enqueue_scripts_styles() {
		...
		if (transfers_does_file_exist('/js/i18n/datepicker-' . $language_code . '.js')) {
			wp_register_script(	'transfers-datepicker-' . $language_code, transfers_get_file_uri('/js/i18n/datepicker-' . $language_code . '.js'), array('jquery', 'jquery-ui-datepicker'), '1.0',true);
		...
		wp_enqueue_script( 'transfers-slicknav', transfers_get_file_uri ('/js/jquery.slicknav.min.js'), array('jquery', 'transfers-jquery-uniform'), '1.0', true );
		wp_enqueue_script( 'transfers-wow', transfers_get_file_uri ('/js/wow.min.js'), array('jquery'), '1.0', true );
		wp_enqueue_script( 'transfers-scripts', transfers_get_file_uri ('/js/scripts.js'), array('jquery', 'transfers-slicknav', 'transfers-jquery-uniform', 'transfers-wow'), '1.0', true );
