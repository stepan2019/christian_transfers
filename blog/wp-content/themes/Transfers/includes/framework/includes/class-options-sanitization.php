...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'transfers' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'transfers' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'transfers' ),
		'repeat'    => esc_html__( 'Repeat All', 'transfers' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'transfers' ),
		'top center'    => esc_html__( 'Top Center', 'transfers' ),
		'top right'     => esc_html__( 'Top Right', 'transfers' ),
		'center left'   => esc_html__( 'Middle Left', 'transfers' ),
		'center center' => esc_html__( 'Middle Center', 'transfers' ),
		'center right'  => esc_html__( 'Middle Right', 'transfers' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'transfers' ),
		'bottom center' => esc_html__( 'Bottom Center', 'transfers' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'transfers')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'transfers' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'transfers')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'transfers' ),
		'italic'      => esc_html__( 'Italic', 'transfers' ),
		'bold'        => esc_html__( 'Bold', 'transfers' ),
		'bold italic' => esc_html__( 'Bold Italic', 'transfers' )
		);
