...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => esc_html__( 'Theme Options', 'theme-textdomain' ),
			'menu_title' => esc_html__( 'Theme Options', 'theme-textdomain' ),
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', esc_html__( 'Default options restored.', 'theme-textdomain' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', esc_html__( 'Options saved.', 'theme-textdomain' ), 'updated fade' );
	}
