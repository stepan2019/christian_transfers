<?php
$temp_dir= explode("/",$_SERVER['REQUEST_URI']);
include ($_SERVER['DOCUMENT_ROOT']."/".$temp_dir[1]."/members/vars.inc.php");
	// ================================================
...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/'.$temp_dir[1].'/images/siteimgs/',
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> '/'.$temp_dir[1].'/images/siteimgs2/',
			'text'    	=> 'Gallery',
		),	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array($_SERVER['DOCUMENT_ROOT']."/".$temp_dir[1].'/images/siteimgs/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
