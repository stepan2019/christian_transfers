...
tinyMceWysiwygSetup.prototype =
{
    ...
    {
        var plugins = 'safari,pagebreak,style,layer,table,advhr,advimage,emotions,iespell,ibrowser,media,searchreplace,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras';
        ...
        var settings = {
            ...
            theme_advanced_buttons3 : 'tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,iespell,ibrowser,media,advhr,|,ltr,rtl,|,fullscreen',
